...
Creeper={
  ...
  __index = {
    ...
    ptOutline=Paint().setColor(0xFF2E7D32).setStrokeWidth(1) .setStyle(Paint.Style.FILL),
    onDraw=function(String_,graph)
      ...
      graph:drawBitmap(res.bitmap.Creeper,String_.p+Vector(-.4,.4),0.05,pt)
    end,
    ...
    onTurnOn=function(cp)
      ...
      soundPool.play(res.sound.Creeper_fuse, 1,1,0,0,1)
